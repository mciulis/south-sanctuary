...
// Resolves a stored path to a usable src.
// Static paths (starting with /) pass through; storage keys are expanded to full URLs.
  ...
  return (
    <>
      ...
      <StorySection
        ...
        body={s.entry?.body ?? []}
        mainImage={{
          src: photo(s.entry?.main_photo, "/images/home/living-south-windows-02.jpg"),
          alt: "Looking down through the glass railings into the main living space",
        }}
        detailImage={{
          src: photo(s.entry?.detail_photo, "/images/home/detail-entry-01.jpg"),
      ...
      <StorySection
        ...
        body={s.kitchen?.body ?? []}
        mainImage={{
          src: photo(s.kitchen?.main_photo, "/images/home/kitchen-island-01.jpg"),
          alt: "The kitchen island with dark matte cabinetry and copper pendant lights",
        }}
        detailImage={{
          src: photo(s.kitchen?.detail_photo, "/images/home/kitchen-fireplace-01.jpg"),
      ...
      <StorySection
        ...
        mainImage={{
          src: photo(s["living-room"]?.main_photo, "/images/home/retreat-drinks-room-landscape-01.jpg"),
          alt: "The living room looking south through eleven windows into the forest canopy",
        }}
        detailImage={{
          src: photo(s["living-room"]?.detail_photo, "/images/home/retreat-drinks-room-south-window-01.jpg"),
      ...
      <StorySection
        ...
        body={s.retreat?.body ?? []}
        mainImage={{
          src: photo(s.retreat?.main_photo, "/images/home/retreat-bathroom-01.jpg"),
          alt: "The master bathroom — soaking tub in niche, floating oak vanity",
        }}
        detailImage={{
          src: photo(s.retreat?.detail_photo, "/images/home/retreat-bedroom-master-02.jpg"),
